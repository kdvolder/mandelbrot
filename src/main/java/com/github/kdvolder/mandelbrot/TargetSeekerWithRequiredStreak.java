 ...
 *
 */
public class TargetSeekerWithRequiredStreak implements TargetSeeker {
	...
	public Bounds find(double desiredWidth) {
		BasicMandelFunction mandel = new BasicMandelFunction(0);
...
//					System.out.println(mandel.max_iter);
	...
	public Point findPointWithValue(int wanted_iterations) {
		...
		BasicMandelFunction mandel = new BasicMandelFunction(wanted_iterations+1);
		Bounds bounds = initialBounds;
